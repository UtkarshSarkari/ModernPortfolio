...
export function Review() {
    return (
        <div className="flex items-center justify-center flex-col py-40 sm:py-60">
            <div className="font-bold text-4xl sm:text-5xl text-white/60 flex items-center gap-2">What People Say About Me<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-11">
