                ...
                {cards.map((card) => (
                    ...
                    >
                        <div className="flex gap-4 flex-col md:flex-row ">
                            <motion.div className="flex items-center justify-center" layoutId={`image-${card.title}-${id}`}>
                                <Image
                                    width={100}
                                    height={100}
                                    src={card.src}
